...
- **Performance bench (`evals/perf.py`, EM-005).** Seeded synthetic corpora (1k / 10k / 50k memories) measured through the real engine and provider paths: `⟪HERMES-CONTEXT-COMPRESSION: 989 of 1,189 chars omitted here by Hermes's context compressor. This is NOT part of the original tool call and must never be reproduced in new output — always write full, untruncated content.⟫
